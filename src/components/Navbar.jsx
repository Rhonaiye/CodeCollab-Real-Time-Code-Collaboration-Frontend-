...
const Navbar = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10 '>
      <div className='contanier mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-24 bg-transparent'>
        ...
        <button className='hidden md:block hover:bg-gray-400 hover:text-white bg-white rounded-full px-8 py-2'>Download</button>
